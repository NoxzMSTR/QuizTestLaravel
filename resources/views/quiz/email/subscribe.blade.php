                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        <h2>Hi, {{ $user->name }}</h2>
                                        <h4>List of users attempts the quiz</h4>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <th width="80%"
                                style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">User</th>
                            <th width="20%"
                                style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px">Score</th>
                        </tr>
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            ...
                            <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                <span class="price" style="float:right; color: #000; font-size: 20px;">{{$item['total']}}</span>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr>
                            <td valign="middle" style="text-align:left; padding: 1em 2.5em;">
                                <p><a href="#" class="btn btn-primary">Take Another Quiz</a></p>
                            </td>
                        </tr>
                    </table>
                </tr><!-- end tr -->
