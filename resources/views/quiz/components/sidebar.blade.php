    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('dashboard')}}" class="nav-link {{Request::url() == route('dashboard') ? 'active' : null}}">
          ...
          <li class="nav-item {{Request::url() == route('viewQuiz') ? 'menu-open' : null}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('viewQuiz')}}" class="nav-link {{Request::url() == route('viewQuiz') ? 'active' : null}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Quiz</p>
                </a>
              </li>
